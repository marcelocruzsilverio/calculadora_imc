  ...
  return (
    <section className="container">
      ...
      <div className={styles.buttonContainer}>
        ...
        <button type="button" onClick={clearFieslds}>
          Limpar
        </button>
      </div>
      ...
      <table cellSpacing="0">
        ...
        <tbody>
          ...
          <tr
            style={{
              backgroundColor:
                result !== null && result < 18.5 ? "red" : "transparent",
            }}
          >
          ...
          <tr
            style={{
              backgroundColor:
                result >= 18.5 && result <= 24.9 ? "lightgreen" : "transparent",
            }}
          >
          ...
          <tr
            style={{
              backgroundColor:
                result >= 25 && result <= 29.9 ? "orange" : "transparent",
            }}
          >
          ...
          <tr
            style={{
              backgroundColor:
                result >= 30 && result <= 39.9 ? "orange" : "transparent",
            }}
          >
